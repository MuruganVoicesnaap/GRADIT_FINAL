...
const VideoPlayer = ({route, setBottomSheetData}) => {
  ...
  const fetchData = useCallback(() => {
    const parseVimeoLink = () => {
      var subject = route?.params?.video.vimeourl;
      ...
      console.log('VimeoID',vimeoVideoId)
      setVideoId(result);
      console.log('resultttt', {result}, 'result[1]', result[1]);
      ...
      <ScrollView>
        {discription ? (
          <View style={styles.topView}>
            ...
            <Text style={{paddingLeft: 5}}>{videoProps.title}</Text>
        ...
        >
          ...
          {/* <Vimeo
            ...
            onPlayProgress={() => console.log('Video progress data:')}
