...
const SubmittedAssigment = ({
  ...
  const getData = useCallback(() => {
    ...
    const request = {
      ...
      processby: route.params.memberid,
      filetype: route.params.assignmenttype,
    };
    assignmentData({
      request,
      isImageType: true,
  ...
  }, [route.params, setPdfList, setImageList, setVideoList]);
        ...
        >
          <View style={styles.pageHeader}>
            ...
            <Text style={styles.pageHeaderText}>
              Submitted by {route.params.studentname}
            </Text>
          </View>
        </TouchableOpacity>
        <View
...
export default connect(mapStatetoProps, mapDispatchToProps)(SubmittedAssigment);
